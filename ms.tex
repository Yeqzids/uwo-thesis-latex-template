...
% Slightly modified by Quan-Zhi Ye, 2016.
...
\usepackage{txfonts}
\usepackage{tocloft}
\usepackage{deluxetable, aas_macros, url, amsmath, textcomp}
...
\newcommand{\super}{Dr. Super Visor} %supervisor
...
\newcommand{\examth}{}
\newcommand{\examf}{}
\newcommand{\department}{Department of Graduation}
\newcommand{\degree}{Doctor of Philosophy}
\newcommand{\firstname}{Defending}
\newcommand{\lastname}{Soon}
...
\textbf{Post-Secondary} & Ph.D. Astronomy, 20XX--20XX\\
...
\begin{itemize}
 \item Defending Soon (2016): I Am Defending Soon. \apj~(in review).
\end{itemize}
